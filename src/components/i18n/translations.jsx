...
const translations = {
  nb: {
    ...
    admin: {
      ...
      scriptSettings: "Skriptinjeksjon",
      scriptSettingsDesc: "Administrer globale skript for analyse og markedsføring.",
  ...
  en: {
    ...
    admin: {
      ...
      scriptSettings: "Script Injection",
      scriptSettingsDesc: "Manage global scripts for analytics and marketing.",
