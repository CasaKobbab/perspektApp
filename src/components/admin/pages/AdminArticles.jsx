  ...
  return (
    <div>
      <div className="flex flex-col gap-4 mb-8 md:flex-row md:items-center md:justify-between">
        ...
        <Link to={createPageUrl("AdminArticleEditor")} className="w-full md:w-auto">
          <Button className="w-full md:w-auto h-11 bg-gradient-to-r from-emerald-500 via-teal-400 to-cyan-500 text-white font-semibold hover:from-emerald-600 hover:via-teal-500 hover:to-cyan-600 shadow-md hover:shadow-lg transition-all duration-300">
